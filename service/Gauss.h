...
#ifndef PROYECTO_PRINCIPAL_MODIFIED_GAUSS_H
#define PROYECTO_PRINCIPAL_MODIFIED_GAUSS_H

class Gauss : public ServiceInterface {
private:
    BmpFile bmpFile;
public:
    Gauss(std::string inpFile, std::string outFile) : ServiceInterface(inpFile, outFile) {}
...
#endif //PROYECTO_PRINCIPAL_MODIFIED_GAUSS_H
